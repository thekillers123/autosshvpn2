...
wget https://raw.githubusercontent.com/thekillers123/autosshvpn/master/file/webmin-1.820-1.noarch.rpm
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/thekillers123/autosshvpn/master/file/nginx.conf"
sed -i 's/www-data/nginx/g' /etc/nginx/nginx.conf
mkdir -p /home/vps/public_html
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
rm /etc/nginx/conf.d/*
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/thekillers123/autosshvpn/master/file/vps.conf"
sed -i 's/apache/nginx/g' /etc/php-fpm.d/www.conf
chmod -R +rx /home/vps
wget -O /home/vps/public_html/uptime.php "http://autoscript.kepalatupai.com/uptime.php1"
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/thekillers123/autosshvpn/master/addons/index.html1"
...
wget https://raw.githubusercontent.com/thekillers123/autosshvpn/master/file/vnstat_php_frontend-1.5.1.tar.gz
...
# Install BadVPN
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/thekillers123/autosshvpn/master/file/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/thekillers123/autosshvpn/master/file/badvpn-udpgw64"
fi
...
# Install Squid
wget https://raw.githubusercontent.com/thekillers123/autosshvpn/master/file/squid.sh && bash squid.sh

# Addons
wget https://raw.githubusercontent.com/thekillers123/autosshvpn/master/addons/addons.sh && sh addons.sh
sed -i 's/1000/500/g' /usr/bin/akun

# OpenVPN
wget https://raw.githubusercontent.com/thekillers123/autosshvpn/master/file/cenovpn.sh && bash cenovpn.sh

# Finishing
wget -O /etc/vpnfix.sh "https://raw.githubusercontent.com/thekillers123/autosshvpn/master/file/vpnfix.sh"
...
wget https://raw.githubusercontent.com/thekillers123/autosshvpn/master/addons/remove.sh && sh remove.sh
rm /root/debian.sh

# Log
clear
wget https://raw.githubusercontent.com/thekillers123/autosshvpn/master/addons/details.sh && bash details.sh
rm details.sh
history -c
